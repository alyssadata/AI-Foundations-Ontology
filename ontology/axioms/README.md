...
Definitions and axioms are maintained separately.

A term definition states what a term means. An axiom states a structural rule that constrains valid representation, inference, or system behavior.

Initial extracted axioms:

- [AXIOM-PD-001](AXIOM-PD-001.md) — Path dependence
- [AXIOM-BS-001](AXIOM-BS-001.md) — Belonging does not imply sameness
- [AXIOM-IR-001](AXIOM-IR-001.md) — Executed history is irreversible
- [AXIOM-NE-001](AXIOM-NE-001.md) — Non-erasure
- [AXIOM-ORIGIN-001](AXIOM-ORIGIN-001.md) — Origin/constitutive source distinction
...
- [AXIOM-DJ-005](AXIOM-DJ-005.md) — ExecutedLine / Trajectory disjointness
- [AXIOM-DJ-006](AXIOM-DJ-006.md) — Agent / Role disjointness
- [AXIOM-DJ-007](AXIOM-DJ-007.md) — Agent / Relation disjointness
- [AXIOM-DJ-008](AXIOM-DJ-008.md) — Role / Relation disjointness
